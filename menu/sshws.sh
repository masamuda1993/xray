...
sshws_menu() {
  ...
  echo ""
  echo -e "  ${WHITE}SSHWS ACCOUNT${NC}"
  echo -e "  ${CYAN}$LINE${NC}"
  echo -e "  ${GREEN}[a]${NC}  Buat Akun SSHWS"
  echo -e "  ${CYAN}$LINE${NC}"
  echo -e "  ${CYAN}[b]${NC}  List Akun SSHWS"
  echo -e "  ${CYAN}$LINE${NC}"
  echo -e "  ${RED}[c]${NC}  Hapus Akun SSHWS"
  echo -e "  ${CYAN}$LINE${NC}"
  echo -e "  ${YELLOW}[d]${NC}  Perpanjang Akun SSHWS"
  echo -e "  ${CYAN}$LINE${NC}"
  echo ""
  ...
  echo -e "  ${CYAN}$LINE${NC}"
  echo ""
  echo -ne "  ${WHITE}Pilih [a-d/0-9]${NC}: "
  read -r choice

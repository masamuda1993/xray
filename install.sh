...
install_ssl() {
  ...
  # Download acme.sh dari chanelog/bin
  ...
  # Fallback official acme.sh jika belum ada
  ...
  # Stop nginx untuk standalone mode
...
install_script_files() {
  ...
  for f in vmess vless nginx dropbear sysinfo changedomain uninstall; do
